...
class ORect   //used to handle the size of the view port
{
public:
	ORect() {}
	ORect(i32 width, i32 height) : width(width), height(height) {} //Constuctors to pass references for used variables
