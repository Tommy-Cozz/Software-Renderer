...
public:
	...
	void setScale(const OVec3& scale)  //A matrix that has scale factors placed along the diagnol, much like the identity matrix
	{
		mat[0][0] = scale.x;
		mat[1][1] = scale.y;
		mat[2][2] = scale.z;
	...
	void setOrthoLH(f32 width, f32 height, f32 nearPlane, f32 farPlane) //allows to define the visuble areas of the world near plane is minimum and far plane is the maximum value of this are 
	{
		mat[0][0] = 2.0f / width;
		mat[1][1] = 2.0f / height;
